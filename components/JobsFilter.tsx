...
import GlobalSearch from "./shared/search/LocalSearchBar";
  ...
  return (
    <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
      ...
      <Select onValueChange={(value) => handleUpdateParams(value)}>
        ...
        <SelectContent className="body-semibold max-h-[350px] max-w-[250px] bg-light-800 text-dark-300 dark:bg-dark-200 dark:text-light-700">
          <SelectGroup>
            {countriesList ? (
